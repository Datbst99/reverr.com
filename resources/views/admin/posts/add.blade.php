...
<div id="content" class="container-fluid">
    <div class="card">
        ...
        <div class="alert alert-success">
            <strong>Success!</strong>Bài viết {{session('alert')}} tạo thành công
        </div>
        @endif
        <div class="card-body">
            <form action="{{route('post.store')}}" method="post">
                ...
                <div class="form-group">
                    <label for="seo-desc">Mô tả SEO</label>
                    <input class="form-control" type="text" name="seo_desc" id="seo-desc" value="{{old('seo_desc')}}">
                    @error('seo_desc')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content_post" id="content-ck" class="content-ck">{{old('content_post')}}</textarea>
                    @error('content_post')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
